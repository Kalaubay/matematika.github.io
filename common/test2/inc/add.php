                ...
                <form action="admin.php?do=save" method="POST">
                    <div class="card mt-4">
                        <div class="card-header">
                            <h2 class="text-center">Добавление тестов</h2>
                        </div>
                        <div class="card-body">
                            <div>
                                    ...
                                    <div class="mt-4">
                                        ...
                                        <div class="answers">
                                            ...
                                            <div class="text-center mt-4">    
                                                <button type="button" class="btn btn-primary addAnswer " data-question="1" data-answer="1">Добавить вариант ответа</button>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="results">
                                ...
                                <div class="text-center mt-4">    
                                    <button type="button" class="btn btn-primary addResult">Добавить результатов</button>
                                </div>
                            </div>
                        </div>
                    </div>
